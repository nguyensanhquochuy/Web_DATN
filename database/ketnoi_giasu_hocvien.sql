...
--
ALTER TABLE `buoi`
  MODIFY `MaBuoi` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `loaigs`
  MODIFY `MaLoaiGS` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `thu`
  MODIFY `MaThu` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `trangthailop`
  MODIFY `MaTTLop` int(11) NOT NULL AUTO_INCREMENT;
