...
if (isset($_GET['edit'])) {
    ...
    if (isset($_POST['save_subject'])) {
        ...
        if ($checkEdit) {
            ...
            $stmt->bind_param("si", $name, $idSubject);
            if ($stmt->execute()) {
                            ...
                            <div class="modal-body">
                                <form method="post">
                                    ...
                                    <div class="submit-section">
                                        <a href="subject.php" class="btn btn-dark submit-btn mr-4">Back</a>
                                        <button class="btn btn-success submit-btn ml-4" type="submit" name="save_subject">Save</button>
