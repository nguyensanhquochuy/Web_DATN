...
if (isset($_GET['edit'])) {
    ...
    if (isset($_POST['save_method'])) {
        ...
        if ($checkEdit) {
            $sql = 'UPDATE hinhthuc SET 
            TenHT = ?
            WHERE MaHT LIKE ?';
            $stmt = $conn->prepare($sql);

            $stmt->bind_param("si", $name, $idMethod);
            if ($stmt->execute()) {
                    ...
                    <div class="row align-items-center">
                        <div class="col">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Sửa hình thức</li>
                            </ul>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="modal-body">
                                <form method="post">
                                    ...
                                    <div class="submit-section">
                                        <a href="method.php" class="btn btn-dark submit-btn mr-4">Back</a>
                                        <button class="btn btn-success submit-btn ml-4" type="submit" name="save_method">Save</button>
